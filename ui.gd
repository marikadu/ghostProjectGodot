...
@onready var ghost_player = get_node_or_null("../GhostPlayer")  # Path to GhostPlayer
@onready var dash_timer_reset = ghost_player.get_node_or_null("dash_timer_reset") if ghost_player else null  # Path to dash_timer_reset inside GhostPlayer
